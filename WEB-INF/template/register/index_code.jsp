    ...
    <header class="g-header">
        ...
        <div class="registerCon">
	        <ul>
    	        ...
    	        <li><input id="code" type="text" placeholder="请输入验证码" >
    	        </li>
    	        <li>
    	        	<img id="codeImg" style="width: 80px; height: 36px;cursor:pointer;border: 1px solid #ccc;border-radius: 2px;" src="/comm/catchca.html">
    	        </li>
