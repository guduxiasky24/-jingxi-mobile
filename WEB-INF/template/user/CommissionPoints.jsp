...
<body>
	<div id="wrapper" class="wrapper">
        ...
        <div class="blessings-title colorbbb">
            <p class="gray9">可用<em class="orange">${user.commissionPoints}</em>福分</p>
            100福分=1元，支付时可抵现金<b id="points"><script type="text/javascript">x=${user.commissionPoints};y=x/100;document.write(y);</script></b>元
        </div>
    ...
    <script language="javascript" type="text/javascript" src="/js/commissionpoints.js?data=20131121"></script>
       <!-- 浮动按钮 -->
