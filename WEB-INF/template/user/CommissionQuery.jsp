...
<div id="wrapper">
    ...
    <input type="hidden" value="${level}" id="hidLevel"/>
        <div class="inviteDetails commiss">
            <p>佣金余额：<em class="orange">￥${user.commissionBalance}</em><cite>（累计收入：￥${user.commissionBalance}）</cite></p>
            <dl id="divList">
            </dl>
            <div id="divLoading" class="loading clearfix g-acc-bg" style="display: none;"><b></b>正在加载</div>
        </div>
    <div class="g-suggest clearfix">请使用电脑访问www.yiydb.cn查看更多</div>
</div>
