...
<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="/css/layoutinvitation.css?data=20131121" />
    <link rel="stylesheet" type="text/css" href="/css/dateinput.css?data=20131121" />
  </head>
...
<script type="text/javascript">
    ...
    <script language="javascript" type="text/javascript" src="/js/mentionlist.js?data=20131121"></script>
