...
<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="/css/layoutframe.css?data=20131121" />
    <link rel="stylesheet" type="text/css" href="/css/userphoto.css?data=20131121" />
    <link rel="stylesheet" type="text/css" href="/css/imgareaselect-animated.css?data=20131121" />
...
<script type="text/javascript">
                    ...
                    <div class="upload">
                        ...
                        <div class="localBtn">
                            ...
                            <div class="btnFile" id="FileControl" style="top: -5px; left: -100.5px;">
                                <input type="file" style="cursor: pointer;" hidefocus="true" name="myFile" class="file" title="" id="fuploadFace" />
                            </div>
                        </div>
                        </form>
                    </div>
    ...
    <script language="javascript" type="text/javascript" src="/js/jquery.imgareaselect.pack.js?data=20131121"></script>
    <script language="javascript" type="text/javascript" src="/js/userphoto.js?data=20131121"></script>
