...
<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="/css/invitedlist.css" />
  </head>
...
<body class="g-acc-bg">
    ...
    <div class="g-suggest clearfix">请使用电脑访问www.yiydb.cn查看更多</div></div>
       <script language="javascript" type="text/javascript" src="/js/invitedlist.js?data=20150923"></script>
       <!-- 浮动按钮 -->
