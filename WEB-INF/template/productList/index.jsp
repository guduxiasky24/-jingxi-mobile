				...
				<ul id="ulGoodsList" class="item">
					<s:iterator value="productList" var="Products">
						<li codeid="${Products.productId }" class="goods-iten">
							...
							<p style="color: #999;font-family: 宋体;font-size: 16px;padding: 0 10px 0;text-align: left;">价值：<span style="background-position: 0 -3px;background-repeat: no-repeat;color: #f60;padding-left: 10px;">￥${Products.productPrice}.00</span>
							</p>
