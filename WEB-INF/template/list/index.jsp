...
<!-- 内页顶部 -->
    ...
    <section class="goodsCon">
	    ...
	    <div class="goodsNav">
            <ul id="divGoodsNav">
       	 	    <li class="current" order="surplus20"><a href="javascript:;">即将揭晓<b></b></a></li>
                ...
                <li order="" class="">
                    ...
                    <dl style="display: none;">
                        ...
                        <s:iterator var="protype" value="protypeList" status="L">
                        <dd type="<s:property value='#protype.typeId'/>"><a href="javascript:;"><b class="g<s:property value="#L.index+2"/>"></b><s:property value='#protype.typeName'/></a></dd>
                        </s:iterator>
                       <!--  <dd type="1002"><a href="javascript:;"><b class="g3"></b>电脑办公</a></dd>
                        <dd type="1003"><a href="javascript:;"><b class="g4"></b>数码影音</a></dd>
                        <dd type="1004"><a href="javascript:;"><b class="g5"></b>女性时尚</a></dd>
                        <dd type="1005"><a href="javascript:;"><b class="g6"></b>美食天地</a></dd>
                        <dd type="1006"><a href="javascript:;"><b class="g7"></b>潮流新品</a></dd>
                        <dd type="1007"><a href="javascript:;"><b class="g8"></b>家用电器</a></dd>
                        <dd type="1041"><a href="javascript:;"><b class="g9"></b>其他商品</a></dd> -->
                    </dl>
                </li>
           </ul>
        </div>
