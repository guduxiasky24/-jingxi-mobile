...
<html>
  <head>
    ...
    <link type="text/css" rel="stylesheet" href="/css/goodsdetail.css" />
  </head>
...
<!--</div>-->
	<!-- 人气推荐结束 -->
    <script language="javascript" type="text/javascript" src="/js/productinfo.js"></script>
    <script language="javascript" type="text/javascript" src="/js/jquery.imagezoom.js"></script>
</body>
</html>