...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/css/qqgroup.css" />
	...
	<body>
			...
			<div class="qqGroup">
				...
				<div class="qqList" id="listTopContents">
					...
					<ul>
						<li>
							<dt>
								<img border="0" width="45px;" height="45px;" src="/Images/qqgroup.png" alt="<%=ApplicationListenerImpl.sysConfigureJson.getSaitName()%>官方001群[s:已满]" />
							</dt>
							<dt>
		...
		<script language="javascript" type="text/javascript" src="/js/qqgroup.js"></script>
	</body>
</html>
